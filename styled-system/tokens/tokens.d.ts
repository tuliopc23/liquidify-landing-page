/* eslint-disable */
export type Token = `colors.${ColorToken}` | `fonts.${FontToken}` | `fontSizes.${FontSizeToken}` | `durations.${DurationToken}` | `lineHeights.${LineHeightToken}` | `letterSpacings.${LetterSpacingToken}` | `radii.${RadiusToken}` | `shadows.${ShadowToken}` | `blurs.${BlurToken}` | `breakpoints.${BreakpointToken}` | `sizes.${SizeToken}` | `gradients.${GradientToken}`
...
export type BlurToken = "glass-sm" | "glass-md" | "glass-lg" | "glass.regular" | "glass.clear" | "material.standard" | "glass.surface" | "glass.strong"
