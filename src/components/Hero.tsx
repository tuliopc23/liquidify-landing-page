  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
        ...
        <div className="floating-element w-96 h-96 bg-apple-blue top-1/4 left-1/4" style={{ animationDelay: '0s' }}></div>
        <div className="floating-element w-80 h-80 bg-apple-purple top-1/3 right-1/4" style={{ animationDelay: '7s' }}></div>
        <div className="floating-element w-64 h-64 bg-apple-teal bottom-1/4 left-1/3" style={{ animationDelay: '14s' }}></div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="mb-8">
          ...
          <div className="inline-flex items-center space-x-2 bg-white/20 backdrop-blur-sm border border-white/30 rounded-full px-4 py-2 mb-8">
            ...
            <span className="font-inter text-sm text-system-gray-700">Now available for React</span>
          </div>
          ...
          <p className="font-inter text-lg sm:text-xl text-system-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            60+ opinionated React components that bring Apple's revolutionary Liquid Glass design language to the web. 
            Crafted with precision following Apple HIG guidelines.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <div className="apple-card-glass p-8 text-left group hover:scale-105 transition-all duration-300">
            ...
            <h3 className="font-inter font-semibold text-lg text-system-gray-900 mb-3">Interactive Components</h3>
            <p className="font-inter text-system-gray-600 text-sm leading-relaxed">Buttons, forms, modals with liquid glass effects and smooth animations</p>
          </div>
          ...
          <div className="apple-card-glass p-8 text-left group hover:scale-105 transition-all duration-300">
            ...
            <h3 className="font-inter font-semibold text-lg text-system-gray-900 mb-3">Layout Systems</h3>
            <p className="font-inter text-system-gray-600 text-sm leading-relaxed">Grids, containers, and responsive layouts that adapt beautifully</p>
          </div>
          ...
          <div className="apple-card-glass p-8 text-left group hover:scale-105 transition-all duration-300">
            ...
            <h3 className="font-inter font-semibold text-lg text-system-gray-900 mb-3">Design Tokens</h3>
            <p className="font-inter text-system-gray-600 text-sm leading-relaxed">Colors, typography, and spacing system following Apple guidelines</p>
          </div>
        </div>
        ...
        <div className="mt-16 max-w-2xl mx-auto">
          <div className="apple-card-glass p-6 text-left">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-inter text-system-gray-500 text-sm ml-4">App.tsx</span>
            </div>
